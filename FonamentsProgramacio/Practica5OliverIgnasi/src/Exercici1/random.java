...
public class random {
	public static void main (String args[]){
		//He trobat convenient adjuntar aquest programa propi on poso de manifest la irregularitat que ofereix 
		// l'us del randomsi no s'usa correctament. En aquest exemple es vol crear un nombre aleatori enter entre l'1 i el 6
